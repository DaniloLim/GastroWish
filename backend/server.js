...
// Update multer configuration for better image quality
const storage = multer.diskStorage({
    ...
    filename: (req, file, cb) => {
        ...
        // Always use .jpg extension for consistent handling
...
const upload = multer({
    ...
    fileFilter: (req, file, cb) => {
        // Accept only high-quality image formats
    ...
    limits: {
        fileSize: 10 * 1024 * 1024, // 10MB max file size (increased for higher quality)
        files: 1
    }
});
